...
public class User {
	...
	public String getGymSlot() {
		return gymSlot;
	}

	public void setGymSlot(String gymSlot) {
	...
	public String getUserAttendence() {
		return userAttendence;
	}

	public void setUserAttendence(String userAttendence) {
		this.userAttendence = userAttendence;
	}
